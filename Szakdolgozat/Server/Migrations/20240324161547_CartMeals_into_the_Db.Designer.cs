...
namespace Szakdolgozat.Server.Migrations
{
    ...
    [Migration("20240324161547_CartMeals_into_the_Db")]
    partial class CartMeals_into_the_Db
    {
            ...
            modelBuilder.Entity("Szakdolgozat.Shared.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 3, 24, 17, 15, 47, 483, DateTimeKind.Local).AddTicks(9319),
                            Email = "user@user.com",
